...
if choice == 'Overview':
    ...
    st.write(""" The data has been split into two groups:
    ...
    st.write('Train Score: {}'.format(round(train_score, 2)))
    st.write('Test Score: {}'.format(round(test_score, 2)))
    ...
    fig, ax = plt.subplots()
    ax.bar(['False Negative', 'True Negative', 'True Positve', 'False Positve'],
    [FN, TN, TP, FP])
    st.pyplot(fig)
